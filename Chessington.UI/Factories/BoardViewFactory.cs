...
namespace Chessington.UI.Factories
{
    ...
    public static class BoardViewFactory
    {
        ...
        {
            var grid = new Grid();
            grid.MaxWidth = grid.MaxHeight =
                grid.Width = grid.Height = GameSettings.BoardSize * InterfaceSettings.SquareSize;
        ...
        private static void CreateSquare(int row, int col, Panel grid)
        {
            ...
            {
                Width = InterfaceSettings.SquareSize, Height = InterfaceSettings.SquareSize,
            ...
            BindingOperations.SetBinding(pieceBorder, Border.BorderBrushProperty,
